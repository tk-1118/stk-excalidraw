import React, {
  ...
  import StandardComponentLibraeyMenuItems from "./StandardComponentLibraeyMenuItems";
  import Spinner from "./Spinner";
  
  import "./StandardComponentLibraeyMenu.scss";
  ...
  const LibraryMenuContent = memo(
    ({
      ...
      return (
        <LibraryMenuWrapper>
          <StandardComponentLibraeyMenuItems
   ...
   */
  export const StandardComponentLibraeyMenu = memo(() => {
    const app = useApp();
